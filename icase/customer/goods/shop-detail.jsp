		    ...
		    _________________________________________________________ -->
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row" id="productMain">
                            <div class="col-sm-6">
                                <div id="mainImage">
                                    <img src="/shop/universal/img/detailbig1.jpg" alt="" class="img-responsive">
                                </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row" id="thumbs">
                                    <div class="col-xs-4">
                                        <a href="/shop/universal/img/detailbig1.jpg" class="thumb">
                                            <img src="/shop/universal/img/detailsquare.jpg" alt="" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="/shop/universal/img/detailbig2.jpg" class="thumb">
                                            <img src="/shop/universal/img/detailsquare2.jpg" alt="" class="img-responsive">
                                        </a>
                                    </div>
                                    <div class="col-xs-4">
                                        <a href="/shop/universal/img/detailbig3.jpg" class="thumb">
                                            <img src="/shop/universal/img/detailsquare3.jpg" alt="" class="img-responsive">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="product">
                                    <div class="image">
                                        <a href="#">
                                            <img src="/shop/universal/img/product2.jpg" alt="" class="img-responsive image1">
                                        </a>
                                    </div>
                                    <div class="text">
                                        <h3>Fur coat</h3>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="product">
                                    <div class="image">
                                        <a href="#">
                                            <img src="/shop/universal/img/product3.jpg" alt="" class="img-responsive image1">
                                        </a>
                                    </div>
                                    <div class="text">
                                        <h3>Fur coat</h3>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="product">
                                    <div class="image">
                                        <a href="#">
                                            <img src="/shop/universal/img/product1.jpg" alt="" class="img-responsive image1">
                                        </a>
                                    </div>
                                    <div class="text">
                                        <h3>Fur coat</h3>
 ...
 _________________________________________________________ -->
                        ...
                        <div class="banner">
                            <a href="shop-category.html">
                                <img src="/shop/universal/img/banner.jpg" alt="sales 2014" class="img-responsive">
                            </a>
                        </div>
                        <!-- /.banner -->
                    </div>
