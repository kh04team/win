...
<tiles:insertAttribute name="header"/>
  ...
  <body class="nav-md">
    ...
    <!-- jQuery -->
    <script src="/shop/admin2/vendors/jquery/dist/jquery.min.js"></script>
    <!-- Bootstrap -->
    <script src="/shop/admin2/vendors/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- FastClick -->
    <script src="/shop/admin2/vendors/fastclick/lib/fastclick.js"></script>
    <!-- NProgress -->
    <script src="/shop/admin2/vendors/nprogress/nprogress.js"></script>
    
    <!-- iCheck -->
    <script src="/shop/admin2/vendors/iCheck/icheck.min.js"></script>    
    
    <!-- Custom Theme Scripts -->
    <script src="/shop/admin2/build/js/custom.min.js"></script>
    
  	<script src="/shop/admin2/production/js/bootstrap-treeview.js"></script>
