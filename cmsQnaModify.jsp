          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Q&A 입력 <small>무엇이든 물어보세요</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate>
                      ...
                      <p>질문 전<code>FAQ 게시판을</code>둘러봐주세요.<a href="fAq.jsp">클릭</a>
                      </p>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telephone">전화번호 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button id="commit" type="button" class="btn btn-primary">작성완료</button>
                          <button id="list" type="button" class="btn btn-success">목록</button>
