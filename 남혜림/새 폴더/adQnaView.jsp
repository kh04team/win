...
<form id="commentform" name="comment" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="/icase/adqna_list.action">Q&A</a>
                            </li>
                            <li>Q&A 상세보기</li>
                        </ul>
                    </div>
  ...
  <button id="qnalist" type="button" class="btn btn-primary" onclick="javascript:location.href='/icase/adqna_list.action';">목록</button>
		</td>
		</tr>
                                </table>
                               <tr>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    ...
    <s:hidden name="no" value="%{resultClass.no}"/>
  	<s:set name="id_admin" value="#session.id"/>
	<s:hidden name="id_admin" value="%{id_admin}"/>
      <div class="row">
            <textarea class="form-control" id="com" name="com" rows="5"></textarea>
      </div>
      <br>
<!--         <div class="col-sm-6 form-group">
        ...
        <!--  <input id="comment" name="comment" type="submit" class="btn btn-default pull-right" value="댓글달기"> -->
