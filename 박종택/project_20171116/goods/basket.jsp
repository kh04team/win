                                        ...
                                        <thead>
                                            <tr>
                                            	<th style="text-align:center;vertical-align:middle;">
                                            		<input type="checkbox" id="basket_check_all" name="basket_check_all" />
                                            	</th>
                                                <th colspan="2">상품</th>
                                                <th>수량</th>
                                                <th>가격</th>
                                        ...
                                        <s:iterator value="list" status="stat">
                                            <tr>
                                                <td style="text-align:center;vertical-align:middle;">
                                                	<input type="checkbox" id="basket_no" name="basket_no" value="${no}" />
                                                </td>                                            
                                                <td>
                                                    <a href="#">
                                                ...
                                                <td>
                                                    <input type="number" id="goods_qty_${no}" name="goods_qty_${no}" value="${goods_qty}" class="form-control" onclick="javascript:qty_value_set('goods_qty_${no}',this.value,${no},${goods_no});" onkeyup="javascript:qty_value_change('goods_qty_${no}',this.value,${no},${goods_no});">
                                                </td>
