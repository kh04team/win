                            ...
                            <div class="col-sm-6">
                                <div class="box">
                                    ...
                                    <form id="goods_detail_form" name="goods_detail_form">
                                        ...
                                        <input type="hidden" id="goods_name" name="goods_name" value="<s:property value="resultClass.goods_name" />">
										...
										<input type="hidden" id="category_no" name="category_no" value="<s:property value="resultClass.category_no" />">
