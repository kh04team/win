...
public class pagingAction {
	...
	public pagingAction(int currentPage, int totalCount, int blockCount, int blockPage, String isSearch)
	{
		...
		//{
			...
			if(isSearch != "")
			{
				...
				else pagingHtml.append("<li class='paginate_button previous "+disabled_text+"' id='datatable-buttons_previous'><a aria-controls='datatable-buttons' data-dt-idx='0' tabindex='0' href='adGoodsList.action?currentPage=" + (currentPage - 1) + "&searchKeyword="+isSearch+">");
			}
			else
			{
				if(disabled_text == "disabled") pagingHtml.append("<li class='paginate_button previous "+disabled_text+"' id='datatable-buttons_previous'><a aria-controls='datatable-buttons' data-dt-idx='0' tabindex='0' href='#'>");
				else pagingHtml.append("<li class='paginate_button previous "+disabled_text+"' id='datatable-buttons_previous'><a aria-controls='datatable-buttons' data-dt-idx='0' tabindex='0' href='adGoodsList.action?currentPage=" + (currentPage - 1) + "'>");
			}
		...
		for(int i = startPage;i<=endPage;i++)
		{
			...
			{
				pagingHtml.append("<li class='paginate_button '><a href='adGoodsList.action?currentPage=");
				pagingHtml.append(i);
				if(isSearch != "")
		...
		//{
			...
			else pagingHtml.append("<li class='paginate_button next "+disabled_text+"' id='datatable-buttons_next'><a aria-controls='datatable-buttons' data-dt-idx='7' tabindex='0' href='adGoodsList.action?currentPage=");
