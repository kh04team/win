                    ...
                    <div class="col-md-9 clearfix" id="basket">
                       ...
                       <div class="form-group">
                        <div style="text-align:left;" class="col-md-5 col-sm-9 col-xs-12" >
                          	주문자이름<input type="text" id="mem_name" name="mem_name" class="form-control" value="${resultMember.mem_name}">
                        </div>                       
						<br/><br/><br/>
                        <div class="col-md-9 col-sm-9 col-xs-12">
	                       <input readonly type="text" id="sample4_postcode" name="zip_code" placeholder="우편번호" value="${resultMember.zip_code}">
							<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기" ><br>
							<input type="text" id="sample4_roadAddress" name="address1" placeholder="주소" readonly style="width:400px;margin-top:5px;"  value="${resultMember.address1}"><br/>
							<input type="text" id="sample4_jibunAddress" name="address2" placeholder="상세주소" style="width:250px;margin-top:5px;"  value="${resultMember.address2}"><br/>
							...
							<span id="guide" style="color:#999"></span>
                                ...
                                <!-- /.table-responsive -->
								<div id="mutongjang" style="display:none;margin-left:20px;">
									무통장 입금계좌 정보<br/>
									신한은행 : 110-259-398022(계좌주 : 박종택)
								</div>
