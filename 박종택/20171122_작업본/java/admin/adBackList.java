...
public class adBackList extends ActionSupport{
	...
	public adBackList() throws IOException
	{
	...
	public String execute() throws Exception {
		...
		list = sqlMapper.queryForList("orderSet.selectBackAll");
	...
	public String search() throws Exception {
		...
		list = sqlMapper.queryForList("orderSet.selectBackSearch", "%"+getSearchKeyword()+"%");
		
		setSearchKeyword(getSearchKeyword());
		
		totalCount = list.size();
		page = new pagingActionNew(currentPage, totalCount, blockCount, blockPage, "", getSearchKeyword(), "adBackList.action");
		pagingHtml = page.getPagingHtml().toString();
