...
public class adRefundList extends ActionSupport{
	...
	public adRefundList() throws IOException
	{
	...
	public String execute() throws Exception {
		...
		list = sqlMapper.queryForList("orderSet.selectRefundAll");
	...
	public String search() throws Exception {
		...
		list = sqlMapper.queryForList("orderSet.selectRefundSearch", "%"+getSearchKeyword()+"%");
		
		setSearchKeyword(getSearchKeyword());
		
		totalCount = list.size();
		page = new pagingActionNew(currentPage, totalCount, blockCount, blockPage, "", getSearchKeyword(), "adRefundList.action");
		pagingHtml = page.getPagingHtml().toString();
