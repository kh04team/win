...
public class pagingActionNew {
	...
	public pagingActionNew(int currentPage, int totalCount, int blockCount, int blockPage, String searchNum, String isSearch, String url)
	{
		...
		//{
			...
			if(isSearch != "")
			{
				...
				else pagingHtml.append("<li class='paginate_button previous "+disabled_text+"' id='datatable-buttons_previous'><a aria-controls='datatable-buttons' data-dt-idx='0' tabindex='0' href='"+url+"?currentPage=" + (currentPage - 1) + "&searchKeyword="+isSearch+"&searchNum="+searchNum+">");
			}
			else
			{
				if(disabled_text == "disabled") pagingHtml.append("<li class='paginate_button previous "+disabled_text+"' id='datatable-buttons_previous'><a aria-controls='datatable-buttons' data-dt-idx='0' tabindex='0' href='#'>");
		...
		for(int i = startPage;i<=endPage;i++)
		{
			...
			{
				pagingHtml.append("<li class='paginate_button '><a href='"+url+"?currentPage=");
				pagingHtml.append(i);
				if(isSearch != "")
		...
		//{
			...
			else pagingHtml.append("<li class='paginate_button next "+disabled_text+"' id='datatable-buttons_next'><a aria-controls='datatable-buttons' data-dt-idx='7' tabindex='0' href='"+url+"?currentPage=");
