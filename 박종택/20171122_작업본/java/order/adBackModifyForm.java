...
public class adBackModifyForm extends ActionSupport {
	...
	public adBackModifyForm() throws IOException
	{
	...
	public String execute() throws Exception {
		...
		resultClass = (order_Status_bin) sqlMapper.queryForObject("orderSet.selectOneBack", paramClass);	
