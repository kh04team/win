...
public class adRefundModifyForm extends ActionSupport {
	...
	public adRefundModifyForm() throws IOException
	{
	...
	public String execute() throws Exception {
		...
		resultClass = (order_Status_bin) sqlMapper.queryForObject("orderSet.selectOneRefund", paramClass);	
