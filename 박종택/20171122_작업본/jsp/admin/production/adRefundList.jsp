          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="title_right">
	                ...
	                <form id="refund_list_search" name="refund_list_search">
		                  <div class="input-group">
		                    ...
		                    <span class="input-group-btn">
		                      <button class="btn btn-default" type="button" id="refund_search_button">검색</button>
		                    </span>
		                  </div>
		            </form>      
                </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title no-link last"><span class="nobr">환불상세</span>
                            </th>
                        ...
                        <tbody>
                        	<s:iterator value="list" status="stat">
	                          ...
	                          <s:else>
	                            ...
	                            <td class=" last"><a href="/icase/adRefundView.action?no=<s:property value="no" />">보기</a>
	                            </td>
	                          </tr>
	                      </s:iterator>
