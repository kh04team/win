                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" name="back_order_form" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">반품사유</label>
                        <div class="col-md-2 col-sm-6 col-xs-12" style="margin-top:8px;">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">반품상태</label>
                        <div class="col-md-2 col-sm-6 col-xs-12" style="margin-top:8px;">
                          <select id="order_status" name="order_status">
                          	<option value="반품신청" <s:if test="%{resultClass.order_status == '반품신청'}"> selected </s:if> >반품신청</option>
                          	<option value="반품처리중" <s:if test="%{resultClass.order_status == '반품처리중'}"> selected </s:if> >반품신청중</option>                          	
                          	<option value="반품완료" <s:if test="%{resultClass.order_status == '반품완료'}"> selected </s:if> >반품완료</option>  
                          	<option value="반품거절" <s:if test="%{resultClass.order_status == '반품거절'}"> selected </s:if> >반품거절</option>                          	                          	
                          </select>
                        </div>
                      </div>                                                                                           
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button class="btn btn-primary" type="button" onclick="javascript:location.href='/icase/adBackList.action';">반품리스트로</button>
                          <button type="button" id="back_order_button" class="btn btn-success">반품상태수정</button>
                        </div>
                      </div>
