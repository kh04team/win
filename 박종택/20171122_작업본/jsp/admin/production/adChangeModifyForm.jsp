                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" name="change_order_form" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">교환사유</label>
                        <div class="col-md-2 col-sm-6 col-xs-12" style="margin-top:8px;">
                      ...
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">교환상태</label>
                        <div class="col-md-2 col-sm-6 col-xs-12" style="margin-top:8px;">
                          <select id="order_status" name="order_status">
                          	<option value="교환신청" <s:if test="%{resultClass.order_status == '교환신청'}"> selected </s:if> >교환신청</option>
                          	<option value="교환처리중" <s:if test="%{resultClass.order_status == '교환처리중'}"> selected </s:if> >교환처리중</option>                          	
                          	<option value="교환완료" <s:if test="%{resultClass.order_status == '교환완료'}"> selected </s:if> >교환완료</option>  
                          	<option value="교환거절" <s:if test="%{resultClass.order_status == '교환거절'}"> selected </s:if> >교환거절</option>                          	                          	
                          </select>
                        </div>
                      </div>                                                                                           
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button class="btn btn-primary" type="button" onclick="javascript:location.href='/icase/adChangeList.action';">교환리스트로</button>
                          <button type="button" id="change_order_button" class="btn btn-success">교환상태수정</button>
                        </div>
                      </div>
