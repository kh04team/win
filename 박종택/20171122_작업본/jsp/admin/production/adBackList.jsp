          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="title_right">
	                ...
	                <form id="back_list_search" name="back_list_search">
		                  <div class="input-group">
		                    ...
		                    <span class="input-group-btn">
		                      <button class="btn btn-default" type="button" id="back_search_button">검색</button>
		                    </span>
		                  </div>
		            </form>      
                </div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title no-link last"><span class="nobr">반품상세</span>
                            </th>
                        ...
                        <tbody>
                        	<s:iterator value="list" status="stat">
	                          ...
	                          <s:else>
	                            ...
	                            <td class=" last"><a href="/icase/adBackView.action?no=<s:property value="no" />">보기</a>
	                            </td>
	                          </tr>
	                      </s:iterator>
