                            ...
                            <form id="basket_form" name="basket_form" method="post" >
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <button type="button" class="btn btn-template-main" onclick="javascript:choice_all_settle();" style="margin-left:5px;">전체결제 <i class="fa fa-chevron-right"></i> 
                                        <button type="button" class="btn btn-template-main" onclick="javascript:choice_select_delete();" style="margin-left:5px;">선택삭제 <i class="fa fa-chevron-right"></i>
                                        <button type="button" class="btn btn-template-main" onclick="javascript:choice_all_delete();" style="margin-left:5px;">전체삭제 <i class="fa fa-chevron-right"></i>                                
