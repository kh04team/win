...
public class adGoodsModify extends ActionSupport {
...
//	private String fileUploadPath="C:\\java\\upload\\";
	...
	public adGoodsModify() throws IOException
	{
	...
	public String execute() throws Exception {
		...
		sqlMapper.update("goods.updateGoods", paramClass);
		
		//System.out.println(getUpload());
		//System.out.println(getUpload2());
		
		if(getUpload() != null)
		{
			paramClass = new goods_bin();
		
			//resultClass = (goods_bin) sqlMapper.queryForObject("goods.selectLastChoiceNo", getGoods_no());
			
			String file_name = "file_main_img_" + getGoods_no();
		...
		{		
			...
			String file_name2 = "file_detail_img_" + getGoods_no();
			...
			sqlMapper.update("goods.updateFile2", paramClass);
